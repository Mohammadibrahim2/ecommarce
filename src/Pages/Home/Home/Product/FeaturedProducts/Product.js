...
const FeaturedProducts=()=>{
    ...
    return(
        <div>
            <h1 className=" text-black text-center font-semibold  text-xl">Featured Products</h1>
            <div className="grid grid-cols-6 gap-2">
                {
                    ...
                    <div class="card-body items-center text-center text-black">
                      ...
                      <div class=" flex flex-row-reverse justify-between font-semibold" style={{fontSize:"8px"}}>
